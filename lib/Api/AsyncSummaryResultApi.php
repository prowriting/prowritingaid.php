...
/**
 * AsyncSummaryResultApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   http://github.com/swagger-api/swagger-codegen
...
class AsyncSummaryResultApi
{
    ...
    /**
     * Operation asyncSummaryResultGetResult
     *
     * 
     *
    ...
    /**
     * Operation asyncSummaryResultGetResultWithHttpInfo
     *
     * 
     *
     * @param string $task_id  (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function asyncSummaryResultGetResultWithHttpInfo($task_id, $licenceCode)
    {
        // verify the required parameter 'task_id' is set
        if ($task_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $task_id when calling asyncSummaryResultGetResult');
        }
        // parse inputs
        $resourcePath = "/api/async/result/summary/{taskId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                '/api/async/result/summary/{taskId}'
            );

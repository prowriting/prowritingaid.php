...
/**
 * AsyncSummaryApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   http://github.com/swagger-api/swagger-codegen
...
class AsyncSummaryApi
{
    ...
    /**
     * Operation asyncSummaryPostWithHttpInfo
     *
     * 
     *
     * @param \Swagger\Client\Model\SummaryAnalysisRequest $request  (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function asyncSummaryPostWithHttpInfo($request, $licenceCode)
    {
        // verify the required parameter 'request' is set
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling asyncSummaryPost');
        }
        // parse inputs
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\AsyncResponseSummaryAnalysisResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\AsyncResponseSummaryAnalysisResponse', $e->getResponseHeaders());

...
class ContextualThesaurusApi
{
    ...
    /**
     * Operation contextualThesaurusPost
     *
     * 
     *
    ...
    /**
     * Operation contextualThesaurusPostWithHttpInfo
     *
     * 
     *
     * @param \Swagger\Client\Model\ContextualThesaurusRequest $request  (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function contextualThesaurusPostWithHttpInfo($request, $licenceCode)
    {
        // verify the required parameter 'request' is set
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling contextualThesaurusPost');
        }
        // parse inputs
        $resourcePath = "/api/contextualthesaurus";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();

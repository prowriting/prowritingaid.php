...
class AnalysisSettings implements ArrayAccess
{
     ...
     * @param int $shortest_average_sentence_length
     * @return $this
     */
     ...
     * @param int $longest_average_sentence_length
     * @return $this
     */
     ...
     * @param int $longest_individual_sentence
     * @return $this
     */
     ...
     * @param int $highest_passive_index
     * @return $this
     */
     ...
     * @param int $min_sentence_variety
     * @return $this
     */
     ...
     * @param double $highest_pronoun_percentage
     * @return $this
     */
     ...
     * @param double $lowest_pronoun_percentage
     * @return $this
     */
     ...
     * @param double $highest_academic_pronoun_percentage
     * @return $this
     */
     ...
     * @param double $highest_initial_pronoun_percentage
     * @return $this
     */
     ...
     * @param double $lowest_initial_pronoun_percentage
     * @return $this
     */
     ...
     * @param double $lowest_we_we_score
     * @return $this
     */
     ...
     * @param double $longest_average_paragraph_length
     * @return $this
     */

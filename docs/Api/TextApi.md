...
# **get**
> \ProWritingAidSDK\Model\AsyncResponseTextAnalysisResponse get($task_id)
...
$apiInstance = new ProWritingAidSDK\Api\TextApi(
...
[**\ProWritingAidSDK\Model\AsyncResponseTextAnalysisResponse**](../Model/AsyncResponseTextAnalysisResponse.md)
...
# **post**
> \ProWritingAidSDK\Model\AsyncResponseTextAnalysisResponse post($requestp)
...
$requestp = new \ProWritingAidSDK\Model\TextAnalysisRequest(); // \ProWritingAidSDK\Model\TextAnalysisRequest | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **requestp** | [**\ProWritingAidSDK\Model\TextAnalysisRequest**](../Model/TextAnalysisRequest.md)|  |

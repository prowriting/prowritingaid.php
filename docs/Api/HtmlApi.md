...
# **get**
> \ProWritingAidSDK\Model\AsyncResponseHtmlAnalysisResponse get($task_id)
...
$apiInstance = new ProWritingAidSDK\Api\HtmlApi(
...
[**\ProWritingAidSDK\Model\AsyncResponseHtmlAnalysisResponse**](../Model/AsyncResponseHtmlAnalysisResponse.md)
...
# **post**
> \ProWritingAidSDK\Model\AsyncResponseHtmlAnalysisResponse post($requestp)
...
$requestp = new \ProWritingAidSDK\Model\HtmlAnalysisRequest(); // \ProWritingAidSDK\Model\HtmlAnalysisRequest | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **requestp** | [**\ProWritingAidSDK\Model\HtmlAnalysisRequest**](../Model/HtmlAnalysisRequest.md)|  |
